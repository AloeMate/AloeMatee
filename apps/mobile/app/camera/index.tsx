...
const styles = StyleSheet.create({
  ...
  card: {
    ...
    padding: 28, borderWidth: 0, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 3,
  },
  ...
  ageInput: {
    ...
    backgroundColor: '#F8F9FA', color: '#1B5E20', fontWeight: 'bold',
